...
- **Home** — feature grid, country cloud, install snippet.
...
- **Examples** — six production-ready integration patterns: react-hook-form + Zod,
  server-side validation, KYC masking, hash-then-store, dynamic pickers, and
  cross-country tax-ID search.
